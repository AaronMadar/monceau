    ...
    },
    {
      ...
      subtext: (
        <>
          Lundi : 9:30 - 19:30<br />
          Mardi : 9:30 - 19:30<br />
          Mercredi : 9:30 - 19:30<br />
          Jeudi : 9:30 - 19:30<br />
          Vendredi : 9:30 - 15:00<br />
          Samedi : Fermé<br />
          Dimanche : Fermé
        </>
      )
                ...
                {contactInfo.map((info, index) => (
                  <div key={index} className="bg-gray-50 rounded-lg p-6 border border-gray-100">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-anthracite-500 font-sans text-sm whitespace-pre-line">
                        {info.subtext}
                      </p>
                    </div>
                  </div>
      ...
      {snackbar.open && (
        <div className="fixed inset-x-0 bottom-4 z-50 px-4">
          <div className="max-w-md mx-auto animate-fade-in-up">
            <div
              className={`shadow-2xl rounded-lg flex items-center justify-between p-4 text-white ${
                snackbar.type === 'success' ? 'bg-primary-900' : 'bg-red-600'
              }`}
            >
