...
const About: React.FC = () => {
  ...
  return (
    <section id="a-propos" className="py-20 lg:py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Story */}
        <div className="bg-white rounded-lg shadow-sm p-8 lg:p-12 mb-16 border border-gray-100">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl lg:text-3xl font-serif font-semibold text-primary-900 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div key={index} className="bg-white rounded-lg shadow-sm p-6 text-center border border-gray-100 group hover:shadow-md transition-shadow duration-300">
                ...
                <h4 className="text-lg font-serif font-semibold text-primary-900 mb-3">
                  {value.title}
                </h4>
        ...
        {/* Quote */}
        <div className="bg-primary-900 text-white rounded-lg p-8 lg:p-12 text-center">
          <blockquote className="text-xl lg:text-2xl font-serif italic leading-relaxed mb-6">
