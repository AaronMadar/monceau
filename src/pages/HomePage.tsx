        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                to="/contact"
                className="bg-white text-primary-900 px-8 py-4 rounded-sm font-sans font-medium hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 text-center"
              >
                Nous contacter
              </Link>
              <Link 
                to="/a-propos"
                className="border-2 border-white text-white px-8 py-4 rounded-sm font-sans font-medium hover:bg-white hover:text-primary-900 transition-all duration-300 text-center"
              >
