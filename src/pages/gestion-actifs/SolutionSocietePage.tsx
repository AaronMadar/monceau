...
const SolutionSocietePage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Solutions Sociétés - Gestion d'Actifs | Monceau David & Co"
        description="Solutions sur mesure pour sociétés et holdings : trésorerie d'entreprise, mandats de gestion, ISR, optimisation fiscale. Expertise dédiée aux entreprises."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl">
            <h1 className="text-4xl lg:text-5xl font-serif font-semibold text-primary-900 mb-8">
              Solutions pour Sociétés
            </h1>
            <p className="text-xl text-anthracite-600 font-sans leading-relaxed">
              Optimisation patrimoniale dédiée aux dirigeants et entreprises avec des solutions 
              sur mesure. De la gestion de trésorerie aux investissements socialement responsables, 
              nous accompagnons les sociétés dans leur stratégie financière et patrimoniale.
            </p>
          </div>
        </div>
      </section>
